...

{
    ...
    'assets': {
        'web.assets_backend': {
            'sh_contact_address_google_place/static/src/scss/sh_contact_address_google_place.scss',
            'sh_contact_address_google_place/static/src/js/sh_contact_address_google_place.js',
